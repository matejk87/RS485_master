...
char comports[MAX_PORT_NUM][13]={"/dev/ttyAT0","/dev/ttyAT1","/dev/ttyAT2","/dev/ttyAT3","/dev/ttyUSB0","/dev/ttyUSB1","/dev/ttyUSB2"};

int OpenComport(int comport_number, int baudrate)
{
  int baudr;

  if((comport_number>=MAX_PORT_NUM)||(comport_number<0))
  {
